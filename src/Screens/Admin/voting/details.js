...
export default function Details() {
    ...
    const vote = async () => {
        ...
        await insurance.methods.finalizeClaim(tmp2[4]).send({
            from: accounts[0]
        });
    }
        ...
        <div style={{ paddingTop: 80 }}>
            {
                (tmp1 != undefined && tmp1[0] != "" && tmp2 !=undefined) ?
                    <div class="card mb-3 text-center">
                        ...
                        <div className='row'>
                            <div className='col'>
                                <a onClick={vote} class="btn btn-primary">Vote Complete</a>
                            </div>
                            {/* <div className='col'>
                                <a href="/insurance/lifeinsurance" class="btn btn-primary"></a>
                            </div> */}
                        </div>
                    </div>
                    :
