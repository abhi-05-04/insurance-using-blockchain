...
export default function Index() {
    ...
    const getQueue = async (id) => {
        ...
        const memb = await tmpInsurance.methods.getClaimList(1).call();
                    ...
                    description: (
                        <Card.Content extra>
                            <div className='buttons'>
                                <Button basic color='black' href="/admin/votingclaim/details" onClick={()=>setdata(memb[i])} style={{ margin: 3 }}>
                                    Show Details
                                </Button>
                            </div>
                        </Card.Content>
